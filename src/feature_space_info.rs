...
pub fn build_function_feature_space(params : &Params, arg_space : &FeatureSpaceInfo, 
...
pub fn build_compressed_feature_space(params : &Params, base_dimensions : usize) -> FeatureSpaceInfo {
...
pub fn build_uncompressed_feature_space(params : &Params, base_dimensions : usize) -> FeatureSpaceInfo {
